  ...
  return(
     <div className="flex h-screen">
      ...
      <div className="w-1/2 flex flex-col justify-center items-center gap-6">
        ...
        <button onClick={googleLogin} className="flex items-center justify-center gap-3 font-medium border rounded-lg w-96 py-3">
        ...
        >
          <label className="flex flex-col gap-2">
            ...
            <input 
              ...
              className="py-3 rounded-lg px-2 border"
          ...
          <label className="flex flex-col gap-2" >
            ...
            <input 
              ...
              className="py-3 rounded-lg px-2 border w-full"
